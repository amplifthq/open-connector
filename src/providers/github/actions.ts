...
type GitHubActionEffect = NonNullable<ActionDefinition["effect"]>;

const githubActionEffects = {
  get_current_user: "read",
  list_my_repositories: "read",
  ...
  create_ref: "write",
  get_commit: "read",
  compare_commits: "read",
  list_repository_issues: "read",
  create_issue: "write",
  get_issue: "read",
  update_issue: "write",
  list_repository_labels: "read",
  create_label: "write",
  list_issue_labels: "read",
  add_issue_labels: "write",
  set_issue_labels: "destructive",
  remove_issue_label: "destructive",
  clear_issue_labels: "destructive",
  add_issue_assignees: "write",
  remove_issue_assignees: "destructive",
  lock_issue: "write",
  unlock_issue: "write",
  list_issue_comments: "read",
  create_issue_comment: "write",
  search_issues_and_pull_requests: "read",
  list_pull_requests: "read",
  list_pull_requests_associated_with_commit: "read",
  list_pull_request_files: "read",
  list_pull_request_commits: "read",
  list_pull_request_requested_reviewers: "read",
  list_pull_request_reviews: "read",
  list_pull_request_review_comments: "read",
  create_pull_request_review: "write",
  submit_pull_request_review: "write",
  create_pull_request_review_comment: "write",
  reply_pull_request_review_comment: "write",
  get_pull_request: "read",
  create_pull_request: "write",
  update_pull_request: "write",
  update_pull_request_branch: "write",
  request_pull_request_reviewers: "write",
  remove_pull_request_reviewers: "destructive",
  merge_pull_request: "destructive",
  check_pull_request_merged: "read",
  create_commit_status: "write",
  get_commit_statuses: "read",
  list_check_runs_for_ref: "read",
  rerequest_check_run: "write",
  rerequest_check_suite: "write",
  list_repository_workflows: "read",
  ...
  list_release_assets: "read",
  list_issue_timeline_events: "read",
  list_issue_events: "read",
  list_repository_issue_events: "read",
  list_public_events: "read",
  list_user_public_events: "read",
  list_user_received_public_events: "read",
  list_authenticated_user_events: "read",
  list_authenticated_user_received_events: "read",
  list_repository_events: "read",
  list_directory_contents: "read",
  get_file_contents: "read",
  merge_branch: "destructive",
  rename_branch: "write",
  sync_fork_branch_with_upstream: "write",
  ...
  list_repository_forks: "read",
  list_repository_tags: "read",
  list_repository_languages: "read",
  list_repository_contributors: "read",
  list_repository_topics: "read",
  replace_repository_topics: "destructive",
  get_repository_readme: "read",
  list_organization_repositories: "read",
  list_user_repositories: "read",
  get_user: "read",
  list_repository_collaborators: "read",
  add_repository_collaborator: "write",
  remove_repository_collaborator: "destructive",
  get_repository_permission_for_user: "read",
  get_ref: "read",
  list_matching_refs: "read",
  update_ref: "destructive",
  delete_ref: "destructive",
  create_commit_comment: "write",
  list_commit_comments: "read",
  star_repository: "write",
  unstar_repository: "destructive",
  check_repository_starred: "read",
  list_repository_stargazers: "read",
  list_my_starred_repositories: "read",
  list_repository_watchers: "read",
  list_milestones: "read",
  get_milestone: "read",
  create_milestone: "write",
  update_milestone: "write",
  delete_milestone: "destructive",
  get_issue_comment: "read",
  update_issue_comment: "write",
  delete_issue_comment: "destructive",
  get_label: "read",
  update_label: "write",
  delete_label: "destructive",
  list_assignees: "read",
  create_issue_reaction: "write",
  create_issue_comment_reaction: "write",
  get_pull_request_review: "read",
  dismiss_pull_request_review: "destructive",
  delete_pending_pull_request_review: "destructive",
  update_pull_request_review_comment: "write",
  delete_pull_request_review_comment: "destructive",
  get_workflow: "read",
  dispatch_workflow: "write",
  cancel_workflow_run: "destructive",
  rerun_failed_jobs: "write",
  enable_workflow: "write",
  disable_workflow: "destructive",
  list_workflow_run_artifacts: "read",
  update_release: "write",
  delete_release: "destructive",
  generate_release_notes: "read",
  get_release_asset: "read",
  delete_release_asset: "destructive",
} as const satisfies Record<string, GitHubActionEffect>;
...
interface GitHubActionInput {
  name: keyof typeof githubActionEffects;
  description: string;
...
function action(input: GitHubActionInput): ActionDefinition {
  return defineProviderAction(service, {
    ...input,
    effect: githubActionEffects[input.name],
